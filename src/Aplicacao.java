...
public class Aplicacao {
    ...
    public static void main(String[] args) throws IOException {
        ...
        CampeonatoBrasileiroImpl resultados =
                new CampeonatoBrasileiroImpl(file, (jogo) -> jogo.data().data().getYear() == 2018);
    ...
    public static void imprimirTabela(Set<PosicaoTabela> posicoes) {
        ...
        int colocacao = 1;
        List<PosicaoTabela> posicoesList = posicoes.stream().sorted((p1, p2) -> Integer.compare(p2.pontos(), p1.pontos())).collect(Collectors.toList());
        for (PosicaoTabela posicao : posicoesList) {
